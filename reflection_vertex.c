...
void write_data_to_latex_reflection(const double *degree, const double *minute, int offset, int data_size_per_set) {
...
double reflection_vertex() {
    ...
    write_data_to_latex_reflection(degree_minute[0], degree_minute[1], 0, data_size_per_set);
    write_data_to_latex_reflection(degree_minute[0], degree_minute[1], 2, data_size_per_set);
